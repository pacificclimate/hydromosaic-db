...
def index():
    ...
    parser = ArgumentParser(description="Index netCDF files into hydromosaic database")
    ...
    parser.add_argument(
        "-p",
        "--metadata_prefix",
        help="prefix for GCM metadata",
        default="downscaling_GCM_",
    )
    ...
    index_directory(
        ...
        gcm_prefix=args.metadata_prefix,
    )
